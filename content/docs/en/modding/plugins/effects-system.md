...
sidebar_label: Entity Effects
sidebar_position: 7
description: Complete documentation of the Hytale entity effects system for buffs, debuffs, and status effects
---
...
|----------|-------------|
| `EXTEND` | Adds the new duration to the remaining duration |
| `OVERWRITE` | Replaces the current effect with the new one |
| `IGNORE` | Keeps the existing effect, ignores the new application |
